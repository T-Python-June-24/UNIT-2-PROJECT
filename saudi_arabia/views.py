...
def set_dark_mode_cookie(response, dark_mode):
...
def index(request):
    ...
    return set_dark_mode_cookie(response, dark_mode)

def dark_mode(request):
    response = redirect(request.META.get('HTTP_REFERER', 'saudi_arabia:index'))
    return set_dark_mode_cookie(response, True)

def light_mode(request):
    response = redirect(request.META.get('HTTP_REFERER', 'saudi_arabia:index'))
    return set_dark_mode_cookie(response, False)
...
def history(request):
    history = {
        'islamic_heritage': {
            ...
            'image': 'images/history/Makkah.jpg',
        ...
        'first_saudi_state': {
            ...
            'image': 'images/history/first-state.jpg',
        ...
        'unification': {
            ...
            'image': 'images/history/unification.jpg',
        ...
        'modern_saudi': {
            ...
            'image': 'images/history/modern_saudi.jpg',
...
def cuisine(request):
    cuisines = [
        ...
        {
            'name': 'Mutabbaq',
            'image': 'images/food/Mutabbaq.jpg',
...
def kings(request):
    kings = [
        {
            'name': 'King Abdulaziz',
            'image': 'images/kings/king-abdulaziz.jpg',
        ...
        {
            'name': 'King Saud',
            'image': 'images/kings/king-saud.jpg',
        ...
        {
            'name': 'King Faisal',
            'image': 'images/kings/king-faisal.jpg',
        ...
        {
            'name': 'King Khalid',
            'image': 'images/kings/king-khalid.jpg',
        ...
        {
            'name': 'King Fahad',
            'image': 'images/kings/king-fahad.jpg',
        ...
        {
            'name': 'King Abdullah',
            'image': 'images/kings/king-abdullah.jpg',
        ...
        {
            'name': 'King Salman',
            'image': 'images/kings/King-salman.jpg',
